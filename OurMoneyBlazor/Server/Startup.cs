...
namespace OurMoneyBlazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<OurMoneyDbContext>(options => options
                .UseSqlite("Data Source=OurMoney.db"));
            //services.AddControllersWithViews();
            //services.AddRazorPages();

            services.AddScoped<IRepository<Dictionary>, Repository<Dictionary>>();
